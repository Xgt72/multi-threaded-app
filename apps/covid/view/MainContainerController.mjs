...
class MainContainerController extends ComponentController {
  ...
  loadSummaryData() {
    fetch(apiSummaryUrl)
      ...
      .catch((err) => console.error("Can't access " + apiSummaryUrl, err))
  ...
  onSwitchThemeButtonClick(data) {
    let me = this,
      ...
      logoPath =
        "https://raw.githubusercontent.com/neomjs/pages/master/resources/images/apps/covid/",
      vdom = logo.vdom,
      view = me.component,
      buttonText,
      cls,
